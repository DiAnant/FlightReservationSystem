...
import com.dianant.projectdemo.service.CustomerService;
...
public class CustomerController {
    ...
    @PutMapping(value = "/{id}")
    public ResponseEntity<String> updateCustomer(@PathVariable Long id,@Valid @RequestBody Customer updatedCustomer){
